...
class ResourcesPanel:
    ...
    def _render_content(self, state, target_tag, is_own):
        ...
        if imgui.begin_table("BottomLayout", 2):
            ...
            imgui.table_next_column()
            self._render_trade_flow_summary(state, target_tag)
    ...
    def _render_trade_flow_summary(self, state, target_tag):
        ...
        imgui.begin_child("TradeFlowSummary", (w, h), child_flags=imgui.ChildFlags_.borders)

        imgui.text_colored(GAMETHEME.colors.accent, "TRADE FLOW SUMMARY")
        imgui.separator()
        ...
        try:
            ...
            if trade.is_empty():
                imgui.text_disabled("No active trade flows.")
                imgui.end_child()
                imgui.pop_style_color()
                return
            ...
            if flows.is_empty():
                imgui.text_disabled("No active trade flows for this country.")
            elif imgui.begin_table("TradeFlowSummaryTable", 4, imgui.TableFlags_.row_bg | imgui.TableFlags_.borders_inner_h):
                imgui.table_setup_column("RESOURCE", imgui.TableColumnFlags_.width_stretch)
            ...
            imgui.text_disabled("Unable to render trade flow summary.")
